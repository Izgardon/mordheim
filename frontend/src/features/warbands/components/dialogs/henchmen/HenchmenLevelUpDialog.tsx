...
export default function HenchmenLevelUpDialog({
  ...
  const isPromoteRoll = roll2d6Total !== null && roll2d6Total >= 10;
  ...
  const handleLevelUpConfirm = async () => {
    if (isPromoteRoll) {
      setLevelUpError("Promotion is required for this roll.");
      return;
    }
    if (!selectedStat) {
  ...
  const handlePromote = () => {
    ...
    setLevelUpError("Promotion flow is not implemented yet.");
  };
      ...
      <DialogContent className="max-w-[560px]">
          ...
          <section className="grid grid-cols-2 gap-6">
            ...
            <div className="flex h-full flex-col gap-3">
              ...
              <div className="mt-auto text-xs text-muted-foreground">
                2-4: +1 Initiative • 5: +1 Strength • 6-7: +1 WS/BS • 8: +1 Attack • 9: +1 Leadership • 10-12: Promote
              </div>
            </div>
          </section>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={isSubmitting || !selectedStat || isPromoteRoll}
          >
