...
import { Dialog, DialogTrigger, SimpleDialogContent } from "@components/dialog"
...
export function UnitSelectionDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <SimpleDialogContent className="max-w-[420px]">
        {title ? <div className="text-center text-sm text-muted-foreground">{title}</div> : null}
